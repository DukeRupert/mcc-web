<script>
	...
	// Theme control - can be connected to a site-wide theme toggle
	let darkMode = false; // You can bind this to your site's theme state
	...
	const socialLinks = [
		...
		},
		{
			...
			show: false, // Example of hiding a social link
